...
// Define an array of toggle element IDs
  ...
  function countToggleStates() {
    ...
    console.log(a);
    console.log(parseInt((a/15)*100));

    document.getElementById("progress").style.width = (parseInt((a/15)*100)).toString()+"%";
    document.getElementById("progress_val").innerHTML = (parseInt((a/15)*100)).toString()+"%";
    document.getElementById("ratio").innerHTML="{"+""+a.toString()+"/15"+"}";
    localStorage.setItem("g",JSON.stringify(parseInt((a/15)*100)));
  ...
  const element14 = document.getElementById(toggleElementIds[13]);
  const element15 = document.getElementById(toggleElementIds[14]);
  ...
  element14.addEventListener('change', function() {
    changestatus(this.checked);
  });
  element15.addEventListener('change', function() {
    changestatus(this.checked);
  });
});
