const array_and_hashing = 9;//a
const two_pointers = 5;//b
const sliding_window = 6;//c
const stack = 7;//d
const binary_search = 7;//e
const linked_list = 11;//f
const trees = 15;//g
const tries = 3;//h
const priority_queue = 7;//i
const backtracking = 9;//j
const graph = 13;//k
const adv_graph = 6;//l
const one_dp = 12;//m
const two_dp = 11;//n
...
// Define an array of toggle element IDs
  ...
  function countToggleStates() {
    ...
    localStorage.setItem("a",JSON.stringify(parseInt((a/9)*100)));
  }
